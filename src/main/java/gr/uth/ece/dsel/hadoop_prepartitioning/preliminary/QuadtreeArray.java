...
import gr.uth.ece.dsel.hadoop_prepartitioning.util.CreateQTreeArray;
...
public final class QuadtreeArray
{
	...
	public static void main(String[] args)
	{
		...
		new CreateQTreeArray(capacity, treeFilePath, treeFileName, trainingDatasetPath, samplerate);
